  ...
  const experiences = [
    {
      ...
      link: "https://www.codesfortomorrow.com/",
      description: [
        "Developing scalable server-side applications using NestJS and TypeScript",
        "Building RESTful APIs with PostgreSQL database integration using Prisma ORM",
        "Learning containerization with Docker for efficient deployment and development workflows",
        "Collaborating with cross-functional teams to implement new features and optimize performance"
      ],
      technologies: ['NestJS', 'TypeScript', 'PostgreSQL', 'Prisma ORM', 'Docker', 'RESTful APIs']
    },
    {
      ...
      technologies: ['React.js', 'Redux Toolkit', 'API Integration', 'SEO Optimization', 'Performance Enhancement']
    }
  ];
